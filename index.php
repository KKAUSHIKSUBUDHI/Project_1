		...
		<!-- Start WOWSlider.com BODY section -->
			...
			<div class="ws_images">
				<ul>
					...
					<li><a href="#3"><img src="data1/images/cycling.jpg" alt="slider" title="cycling" id="wows1_1"/></a></li>
				...
				<div class="ws_script" style="position:absolute;left:-99%">
					<a href="#">wowslideshow</a> by WOWSlider.com v8.7
				</div>
